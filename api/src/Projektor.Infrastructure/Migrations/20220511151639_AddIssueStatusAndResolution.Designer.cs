...
namespace Projektor.Infrastructure.Migrations
{
    ...
    [Migration("20220511151639_AddIssueStatusAndResolution")]
    partial class AddIssueStatusAndResolution
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Projektor.Core.Comments.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Projektor.Core.Worklogs.Worklog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasCheckConstraint("CHK_Worklogs_StartedEnded", "\"StartedAt\" < \"EndedAt\"");
                });
            ...
            modelBuilder.Entity("Projektor.Core.Comments.Comment", b =>
                {
                    b.HasOne("Projektor.Core.Issues.Issue", "Issue")
                        .WithMany()
